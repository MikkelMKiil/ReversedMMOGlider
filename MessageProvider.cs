...
public class MessageProvider
{
    ...
    public MessageProvider(string string_6)
    {
        string_4 = string_6;
        ...
        {
            Logger.LogMessage("No string filename: " + str1);
            ...
            {
                Logger.LogMessage("No other language files matching " + str2 + "*.xml, falling back to en-US");
            }
        }
    ...
    public static void smethod_0(string string_6)
    {
        ...
        {
            Logger.smethod_1("** Exception reading strings: " + ex.Message);
            Logger.smethod_1("** Last string: " + gclass30_0.string_3);
        }
    }

    private string[] method_0(string string_6, SortedList sortedList_4, SortedList sortedList_5)
    {
        Logger.LogMessage("Loading: " + string_6);
                ...
                if (xmlReader.NodeType == XmlNodeType.Element && xmlReader.Name == "S")
                {
                    ...
                    if (smethod_8(attribute1))
                    {
                        ...
                        if (num != arrayList.Count + 1)
                            Logger.LogMessage("ID #" + num + " is out of order, should be #" + (arrayList.Count + 1));
        ...
        {
            Logger.LogMessage("** Exception loading strings from " + string_6 + ": " + ex.Message + ex.StackTrace);
            Logger.LogMessage("** Last string: " + string_3);
        }

        return (string[])arrayList.ToArray(typeof(string));
    }

    public static string GetMessage(int int_0)
    {
    ...
    {
        return string.Format(GetMessage(int_0), object_0);
    }

    public static void smethod_3(Form form_0, string string_6)
    {
        Logger.smethod_1("Localizing form: " + string_6);
    ...
    private void method_2(Control control_0, string string_6)
    {
        ...
        if (type == typeof(Label))
            ...
            Logger.smethod_1("! Couldn't localize: " + control_0.Name);
    }
