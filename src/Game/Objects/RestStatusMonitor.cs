...
public class RestStatusMonitor
{
    ...
    {
        double_4 = ConfigManager.gclass61_0.method_3("RestHealth") / 100.0;
        double_5 = ConfigManager.gclass61_0.method_3("RestMana") / 100.0;
    }
    ...
    {
        if (GObjectList.GetNearestAttacker(0L) != null || !(ConfigManager.gclass61_0.method_2("UseBandages") == "True"))
            return false;
        if (gplayerSelf_0.Health * 100.0 < ConfigManager.gclass61_0.method_3("BandageHealth") && gspellTimer_0.IsReady)
        {
