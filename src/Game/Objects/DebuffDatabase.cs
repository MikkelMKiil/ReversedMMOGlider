...
public class DebuffDatabase
{
    ...
    protected DebuffType method_2(string string_0)
    {
        ...
        {
            case "MAGIC":
                return DebuffType.const_1;
            case "POISON":
                return DebuffType.const_2;
            case "CURSE":
                return DebuffType.const_3;
            case "DISEASE":
                return DebuffType.const_4;
            default:
                return DebuffType.const_0;
        }
    }

    protected string method_3(DebuffType genum4_0)
    {
        switch (genum4_0)
        {
            case DebuffType.const_1:
                return "Magic";
            case DebuffType.const_2:
                return "Poison";
            case DebuffType.const_3:
                return "Curse";
            case DebuffType.const_4:
                return "Disease";
            default:
                return "Unknown";
        }
    ...
    {
        if (!ConfigManager.gclass61_0.method_5("RemoveDebuffs"))
            return false;
