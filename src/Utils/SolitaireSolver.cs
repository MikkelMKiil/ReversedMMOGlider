...
public class SolitaireSolver
{
    ...
    public void method_0()
    {
        ...
        var int_1 = GProcessMemoryManipulator.smethod_11(num + SolitaireMemoryOffsets.int_0, "md0");
        if (int_1 == 0)
    ...
    private bool method_4(SolitaireGameState gclass34_0)
    {
    ...
    private bool method_5(SolitaireGameState gclass34_0)
    {
    ...
    private bool method_6(SolitaireGameState gclass34_0)
    {
        for (var index1 = 6; index1 >= 0; --index1)
        {
            var gclass80_1 = gclass34_0.gclass80_3[index1];
    ...
    private bool method_7(SolitaireGameState gclass34_0)
    {
    ...
    private bool method_8(SolitaireGameState gclass34_0)
    {
        var gclass7_1 = gclass34_0.gclass80_1.method_4();
    ...
    private bool method_9(SolitaireGameState gclass34_0)
    {
        if (gclass34_0.gclass80_0.gclass7_0.Length <= 0)
            return false;
