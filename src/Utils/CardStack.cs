...
public class CardStack
{
    ...
    {
        var length = GProcessMemoryManipulator.smethod_11(int_0 + SolitaireMemoryOffsets.int_9, "md10");
        gclass7_0 = new PlayingCard[length];
        for (var index = 0; index < length; ++index)
        {
            var int_5 = GProcessMemoryManipulator.smethod_11(GProcessMemoryManipulator.smethod_11(int_0 + SolitaireMemoryOffsets.int_10, "md11") + 4 * index, "md12");
            gclass7_0[index] = new PlayingCard(int_5, this);
        }

        int_1 = 0;
        int_2 = 0;
        var num = GProcessMemoryManipulator.smethod_11(int_0 + SolitaireMemoryOffsets.int_13, "md13");
        int_1 = GProcessMemoryManipulator.smethod_11(num + SolitaireMemoryOffsets.int_15, "md14");
        int_2 = GProcessMemoryManipulator.smethod_11(num + SolitaireMemoryOffsets.int_16, "md15");
    }
