...
public class UIElement
{
    ...
    {
        string_0 = "(no name)";
        var int_29 = GProcessMemoryManipulator.smethod_11(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIName"), "onamer");
        if (int_29 != 0)
    ...
    {
        var int_29 = GProcessMemoryManipulator.smethod_11(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UILabelText"), "labeltextptr");
        if (int_29 == 0 || (int_29 & 1) == 1)
        {
            ...
            {
                var num2 = GProcessMemoryManipulator.smethod_11(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIFontString"), "fontstringptr");
                if (num2 != 0)
                    int_29 = GProcessMemoryManipulator.smethod_11(num2 + MemoryOffsetTable.Instance.GetIntOffset("UILabelText"), "labeltextptr2");
            }
        }
    ...
    private void method_4()
    {
        ...
        var num = GProcessMemoryManipulator.smethod_11(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIChildren"), "childrenptr");
        if (num == 0)
            return;
        do
        {
            var int_1 = GProcessMemoryManipulator.smethod_11(num + MemoryOffsetTable.Instance.GetIntOffset("UIChildStep"), "childstep");
            if ((int_1 & ushort.MaxValue) != 0)
            {
                list_0.Add(new UIElement(int_1));
                num = GProcessMemoryManipulator.smethod_11(num + MemoryOffsetTable.Instance.GetIntOffset("UIChildNext"), "childnext");
            }
            else
            {
                goto label_1;
    ...
    {
        list_0 = new List<UIElement>();
        var num1 = GProcessMemoryManipulator.smethod_11(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIChildren"), "uichild1");
        var num2 = 150;
        if (num1 != 0)
            do
            {
                var int_1 = GProcessMemoryManipulator.smethod_11(num1 + MemoryOffsetTable.Instance.GetIntOffset("UIChildStep"), "uichild2");
                if ((int_1 & ushort.MaxValue) != 0)
                {
                    if ((int_1 & 1) == 0)
                    {
                    ...
                    num1 = GProcessMemoryManipulator.smethod_11(num1 + MemoryOffsetTable.Instance.GetIntOffset("UIChildNext"), "uichild3");
                    if (num1 != 0)
                        --num2;
                    else
                        break;
        ...
        var int_1_1 = GProcessMemoryManipulator.smethod_11(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIChildrenOneShot"), "uichild1s");
    ...
    {
        return GProcessMemoryManipulator.smethod_11(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIMenuVisible"), "tfvisible") != 0;
    }
    ...
    {
        var int_1 = GProcessMemoryManipulator.smethod_11(MemoryOffsetTable.Instance.GetIntOffset("UIParent"), "uiparent");
        if (int_1 != 0)
    ...
    {
        var num1 = GProcessMemoryManipulator.smethod_11(MemoryOffsetTable.Instance.GetIntOffset("UIGlue1"), "uig1");
        var num2 = GProcessMemoryManipulator.smethod_11(MemoryOffsetTable.Instance.GetIntOffset("UIGlue2"), "uig2");
    ...
    private static UIElement smethod_4(int int_1, string string_1)
    {
        do
        {
            var int_29 = GProcessMemoryManipulator.smethod_11(int_1 + MemoryOffsetTable.Instance.GetIntOffset("UIName"), "oname2");
            if (int_29 != 0)
                goto label_2;
            label_1:
            int_1 = GProcessMemoryManipulator.smethod_11(int_1 + MemoryOffsetTable.Instance.GetIntOffset("UINext"), "onextnb");
            continue;
            label_2:
    ...
    {
        var num1 = GProcessMemoryManipulator.smethod_11(MemoryOffsetTable.Instance.GetIntOffset("UIParent"), "uiparent");
        if (num1 == 0)
        {
        ...
        do
        {
            var int_29 = GProcessMemoryManipulator.smethod_11(num2 + MemoryOffsetTable.Instance.GetIntOffset("UIName"), "oname3");
            if (int_29 != 0)
                goto label_4;
            label_3:
            num2 = GProcessMemoryManipulator.smethod_11(num2 + MemoryOffsetTable.Instance.GetIntOffset("UINext"), "onextga");
            continue;
            label_4:
