...
public class AutomationStep
{
    ...
    {
        list_0 = new List<ProfileStepCondition>();
        bool_2 = true;
    }
    ...
    public void method_4(XmlNode xmlNode_0)
    {
        ...
        foreach (XmlNode selectNode in xmlNode_0.SelectNodes("Condition"))
            method_7(new ProfileStepCondition((StepConditionType)int.Parse(selectNode.Attributes["ConditionType"].Value),
                int.Parse(selectNode.Attributes["Parameter"].Value),
                int.Parse(selectNode.Attributes["NextStep"].Value)));
    }

    public void method_5(StepConditionType genum6_0)
    {
    ...
    public ProfileStepCondition method_6(StepConditionType genum6_0)
    {
    ...
    public void method_7(ProfileStepCondition gclass51_0)
    {
