...
public class WardenCheckDatabase
{
    ...
    {
        var gclass15List = new List<WardenCheckDiagram>();
    ...
    public void method_1(byte[] byte_0)
    {
        ...
        {
            var gclass15_1 = new WardenCheckDiagram(smethod_1(memoryStream_0), "default " + index1);
            ...
            for (var index2 = 0; index2 < num2; ++index2)
            {
                ...
                if (wfconditionType_1 != WFConditionType.DataBytes && wfconditionType_1 != WFConditionType.CodeBytes)
                {
                    ...
                    var gclass53 = new WardenCondition(wfconditionType_1, int_1, string_1, gclass15_1);
                    gclass15_1.list_0.Add(gclass53);
                }
                else
                {
                    var gclass29_1 = new ByteSignaturePattern(memoryStream_0);
                    var gclass53 = new WardenCondition(wfconditionType_1, int_1, gclass29_1, gclass15_1);
                    gclass15_1.list_0.Add(gclass53);
                }
            }
