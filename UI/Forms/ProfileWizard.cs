...
public class ProfileWizard : Form
{
    ...
    private void method_1()
    {
        switch (enum0_0)
        {
            ...
            case Enum0.const_4:
                ...
                SkipVendorBox.Checked = !StartupClass.IsLicenseValid;
                break;
            case Enum0.const_5:
    ...
    private void timer_0_Tick(object sender, EventArgs e)
    {
        try
        {
            if (!StartupClass.IsGameProcessAttached || enum0_0 == Enum0.const_0)
                return;
            switch (enum0_0)
            {
                case Enum0.const_1:
    ...
    {
        if (SkipVendorBox.Checked || StartupClass.IsLicenseValid || MessageBox.Show(this,
