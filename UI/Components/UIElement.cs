...
public class UIElement
{
    ...
    {
        string_0 = "(no name)";
        var int_29 = GameMemoryAccess.ReadInt32(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIName"), "onamer");
        if (int_29 != 0)
            string_0 = GameMemoryAccess.ReadString(int_29, 200, "objectnamer");
        else
            bool_0 = false;
        var num = MemoryOffsetTable.Instance.GetIntOffset("UICoordBase");
        float_5 = GameMemoryAccess.ReadFloat(int_0 + num, "uiobjbottom");
        float_2 = GameMemoryAccess.ReadFloat(int_0 + num + 4, "uiobjleft");
        float_3 = GameMemoryAccess.ReadFloat(int_0 + num + 8, "uiobjtop");
        float_4 = GameMemoryAccess.ReadFloat(int_0 + num + 12, "uiobjright");
    }
    ...
    {
        var int_29 = GameMemoryAccess.ReadInt32(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UILabelText"), "labeltextptr");
        if (int_29 == 0 || (int_29 & 1) == 1)
        {
            var num1 = GameMemoryAccess.ReadInt32(int_0, "GameClass");
            if (num1 == MemoryOffsetTable.Instance.GetIntOffset("UITypeLabel1") ||
                num1 == MemoryOffsetTable.Instance.GetIntOffset("UITypeLabel2"))
            {
                var num2 = GameMemoryAccess.ReadInt32(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIFontString"), "fontstringptr");
                if (num2 != 0)
                    int_29 = GameMemoryAccess.ReadInt32(num2 + MemoryOffsetTable.Instance.GetIntOffset("UILabelText"), "labeltextptr2");
            }
        }

        return int_29 != 0 && (int_29 & 1) != 1 ? GameMemoryAccess.ReadStringInternal(int_29, 200, "labeltext1") : "(no text)";
    }

    private void method_4()
    {
        list_0 = new List<UIElement>();
        var num = GameMemoryAccess.ReadInt32(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIChildren"), "childrenptr");
        if (num == 0)
            return;
        do
        {
            var int_1 = GameMemoryAccess.ReadInt32(num + MemoryOffsetTable.Instance.GetIntOffset("UIChildStep"), "childstep");
            if ((int_1 & ushort.MaxValue) != 0)
            {
                list_0.Add(new UIElement(int_1));
                num = GameMemoryAccess.ReadInt32(num + MemoryOffsetTable.Instance.GetIntOffset("UIChildNext"), "childnext");
            }
            else
            {
                goto label_1;
    ...
    {
        list_0 = new List<UIElement>();
        var num1 = GameMemoryAccess.ReadInt32(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIChildren"), "uichild1");
        var num2 = 150;
        if (num1 != 0)
            do
            {
                var int_1 = GameMemoryAccess.ReadInt32(num1 + MemoryOffsetTable.Instance.GetIntOffset("UIChildStep"), "uichild2");
                if ((int_1 & ushort.MaxValue) != 0)
                {
                    if ((int_1 & 1) == 0)
                    {
                    ...
                    num1 = GameMemoryAccess.ReadInt32(num1 + MemoryOffsetTable.Instance.GetIntOffset("UIChildNext"), "uichild3");
                    if (num1 != 0)
                        --num2;
                    else
                        break;
        ...
        var int_1_1 = GameMemoryAccess.ReadInt32(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIChildrenOneShot"), "uichild1s");
    ...
    {
        return GameMemoryAccess.ReadInt32(int_0 + MemoryOffsetTable.Instance.GetIntOffset("UIMenuVisible"), "tfvisible") != 0;
    }
    ...
    private static UIElement smethod_4(int int_1, string string_1, bool logIfMissing)
    {
        do
        {
            var int_29 = GameMemoryAccess.ReadInt32(int_1 + MemoryOffsetTable.Instance.GetIntOffset("UIName"), "oname2");
            if (int_29 != 0)
                goto label_2;
        label_1:
            int_1 = GameMemoryAccess.ReadInt32(int_1 + MemoryOffsetTable.Instance.GetIntOffset("UINext"), "onextnb");
            continue;
        label_2:
            var str = GameMemoryAccess.ReadString(int_29, 200, "objectnamenb");
            switch (str)
            {
                case "(read failed)":
                    goto label_5;
    ...
    {
        var num1 = GameMemoryAccess.ReadInt32(MemoryOffsetTable.Instance.GetIntOffset("UIParent"), "uiparent");
        if (num1 == 0)
        {
        ...
        do
        {
            var int_29 = GameMemoryAccess.ReadInt32(num2 + MemoryOffsetTable.Instance.GetIntOffset("UIName"), "oname3");
            if (int_29 != 0)
                goto label_4;
        label_3:
            num2 = GameMemoryAccess.ReadInt32(num2 + MemoryOffsetTable.Instance.GetIntOffset("UINext"), "onextga");
            continue;
        label_4:
            var str = GameMemoryAccess.ReadString(int_29, 200, "objectnamega");
            stringList.Add(str);
            goto label_3;
        } while (num2 != 0);
