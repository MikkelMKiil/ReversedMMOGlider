...
public class InputController
{
    ...
    public static void smethod_18(double double_2, double double_3)
    {
        int int_29;
        int int_30;
        GameMemoryAccess.WorldToScreen(double_2, double_3, out int_29, out int_30);
    ...
    public static void smethod_22(out double double_2, out double double_3)
    {
        ...
        double double_0;
        double double_1;
        GameMemoryAccess.ScreenToWorld(out double_0, out double_1, gstruct12_0.int_0, gstruct12_0.int_1);
        double_2 = double_0;
        double_3 = double_1;
    }
