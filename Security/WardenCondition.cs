...
public class WardenCondition
{
    public WardenCheckDiagram gclass15_0;
    public ByteSignaturePattern gclass29_0;
    public int int_0;
    public string string_0;
    public WFConditionType wfconditionType_0;

    public WardenCondition(
        WFConditionType wfconditionType_1,
        int int_1,
        string string_1,
        WardenCheckDiagram gclass15_1)
    {
        ...
        if (wfconditionType_1 != WFConditionType.CodeBytes && wfconditionType_1 != WFConditionType.DataBytes)
            ...
            gclass29_0 = new ByteSignaturePattern(string_1);
    }

    public WardenCondition(
        WFConditionType wfconditionType_1,
        int int_1,
        ByteSignaturePattern gclass29_1,
        WardenCheckDiagram gclass15_1)
    {
        wfconditionType_0 = wfconditionType_1;
        int_0 = int_1;
