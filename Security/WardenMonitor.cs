...
public class WardenMonitor
{
    ...
    private readonly WardenProtocol gclass71_0;
    private int int_0;
    private int int_1;
    private int int_2;
    ...
    public WardenMonitor(WardenProtocol gclass71_1, bool bool_2, int int_3)
    {
    ...
    private WardenCheckStatus method_8()
    {
        ...
        try
        {
            WardenProtocol.GEnum10 genum10_0;
            ...
            if (genum10_0 != WardenProtocol.GEnum10.const_2 && genum10_0 != WardenProtocol.GEnum10.const_3)
            {
                ...
                switch (str)
                {
                    case "Safe":
                        ...
                        break;
                    case "Unsafe":
                        int_3 = WardenCheckStatus.const_1;
                        gclass71_0.method_30();
                        flag2 = true;
                        break;
                    case "ReqFP":
                        ...
                        break;
                    default:
                        int_3 = WardenCheckStatus.const_2;
                        gclass71_0.method_30();
                        flag2 = true;
                        break;
                }
    ...
    private WardenCheckStatus method_20(byte[] byte_1)
    {
        string_1 = "(step0)";
        var gclass46 = new WardenPatternMatcher(new PEImageParser(byte_1));
        ...
        gclass19_0 = new WardenCheckDatabase();
