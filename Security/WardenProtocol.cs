...
public class WardenProtocol
{
    ...
    private bool bool_2;
    private byte[] byte_0;
    private WardenStateValue genum9_0;
    private int int_11;
    private int int_12;
    private int int_13;
    private int int_14;
    ...
    public WardenProtocol(string string_2)
    {
        string_0 = string_2;
    ...
    public static WardenStateValue smethod_2(bool bool_3)
    {
    ...
    public static void smethod_4()
    {
        foreach (var file in Directory.GetFiles(Environment.CurrentDirectory, "*.sys"))
        {
            ...
            new WardenProtocol(string_2).method_11();
        }
    }
    ...
    {
        var gclass71 = new WardenProtocol(string_2);
