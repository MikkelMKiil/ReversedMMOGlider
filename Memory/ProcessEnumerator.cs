...
public class ProcessEnumerator
{
    ...
    public void method_0()
    {
        ...
        {
            var gclass66 = new ProcessInfo((int)struct0_0.uint_2, struct0_0.string_0);
            if (!bool_0)
        ...
        gclass66_0 = (ProcessInfo[])arrayList.ToArray(typeof(ProcessInfo));
    }
    ...
    public ProcessInfo method_3(string string_0)
    {
        if (gclass66_0 == null)
            return null;
        foreach (var gclass66 in gclass66_0)
