...
public class ChatLogManager
{
    ...
    public ChatFrameLocator gclass75_0;
    public ChatFrameLocator gclass75_1;
    ...
    {
        var string_2 = "ChatFrame" + method_18(ConfigManager.gclass61_0.method_2("ChatLogFrame"));
        if (gclass75_0 == null)
            gclass75_0 = new ChatFrameLocator(string_2);
    ...
    {
        var string_2 = "ChatFrame" + method_18(ConfigManager.gclass61_0.method_2("CombatLogFrame"));
        if (gclass75_1 == null)
            gclass75_1 = new ChatFrameLocator(string_2);
                ...
                foreach (var str1 in string_3)
                    ...
                    else
                    {
                        ...
                        if ((str1.IndexOf("|cff0070dd") > 0 || str1.IndexOf("|cffa335ee") > 0) &&
                            ...
                            SoundPlayer.smethod_0("Blue.wav");
                    }
            }
            catch (Exception ex)
            {
    ...
    protected void method_7(string string_2, string string_3)
    {
        ...
        else
        {
            ...
            if (ConfigManager.gclass61_0.method_2("ChatAutoReply") == "True")
            {
    ...
    {
        if (!(ConfigManager.gclass61_0.method_2("ChatDelete") == "True"))
            return;
