...
public class CombatController
{
    ...
    private void method_0()
    {
        ...
        if (StartupClass.CurrentGameClass != null && StartupClass.CurrentProfile != null)
        {
            ...
            else
            {
                ...
                bool_13 = ConfigManager.gclass61_0.method_2("Strafe") == "True";
    ...
    public static void smethod_0(int int_15)
    {
        ...
        if (MessageBox.Show(StartupClass.MainForm, MessageProvider.GetMessage(int_15), GameMemoryAccess.GenerateRandomString(),
    ...
    public void method_4()
    {
        ...
        {
            if (!gprofile_0.Fishing && gclass54_0.genum7_0 != PartyRole.const_2)
            {
            ...
            else if (gprofile_0.LureMinutes > 0)
            {
                ...
                gclass36_2 = new GameTimer(gprofile_0.LureMinutes * 60 * 1000);
                gclass36_2.method_4();
            }
            else
            {
            ...
            if (StartupClass.IsGliderInitialized && StartupClass.MainForm != null &&
                GameMemoryAccess.GetForegroundWindow() == StartupClass.MainApplicationHandle)
                StartupClass.MainForm.Activate();
            ...
            do
            {
                ...
                label_16:
                    ...
                    goto label_2;
                         ...
                         !(ConfigManager.gclass61_0.method_2("SitWhenBored") == "True") || gprofile_0.IgnoreAttackers);
    ...
    public void method_8()
    {
        ...
        else
        {
            ...
            var flag2 = StartupClass.gclass54_0.genum7_0 != PartyRole.const_0 &&
    ...
    public bool method_30(ulong long_1, double double_8, double double_9, double double_10)
    {
        ...
        for (var double_3 = 0.08; double_3 < 0.6 && !flag; double_3 += double_10)
            for (var double_2 = double_8; double_2 < double_9; double_2 += double_10)
            {
                ...
                GameMemoryAccess.Sleep(20U);
                if (GameMemoryAccess.ReadInt64(int_29, "UnderCursor3") != long_1)
                {
                    if (bool_10)
                        return false;
                }
        ...
        {
            StartupClass.smethod_39(500);
            flag = GameMemoryAccess.ReadInt64(int_29, "UnderCursor4") == long_1;
        }
        ...
        label_6:
            ...
            if (gclass36_1.method_3())
            {
                ...
                if (!ProfileGroupManager.smethod_3())
                {
                    ...
                    if (!gprofile_0.IgnoreAttackers)
                        method_52(true);
                    if (int_7 == gprofile_0.Waypoints.Count * 2 && ConfigManager.gclass61_0.method_5("SitWhenBored") &&
    ...
    public void method_45(GNode gnode_0)
    {
        ...
        else
        {
            ...
            var num = 0;
            gnode_0.Hover();
            if (!method_18(GameMemoryAccess.ReadInt32(MemoryOffsetTable.Instance.GetIntOffset("CursorType"), "CursorType")))
            {
            ...
            else
            {
                for (; num < 9; ++num)
                    if (!method_19())
                    {
                        var int_15 = GameMemoryAccess.ReadInt32(MemoryOffsetTable.Instance.GetIntOffset("CursorType"), "CursorType");
                        if (method_18(int_15))
                        {
                            method_56();
                            Thread.Sleep(1000);
    ...
    {
        method_14(
            new GLocation(GameMemoryAccess.ReadFloat(MemoryOffsetTable.Instance.GetIntOffset("CorpseLocation") - 8, "CorpseX"),
                (double)GameMemoryAccess.ReadFloat(MemoryOffsetTable.Instance.GetIntOffset("CorpseLocation") - 4, "CorpseY")), false);
    ...
    public bool method_52(bool bool_20)
    {
        DialogMonitor.smethod_2();
        var flag = false;
        var num = !bool_20 || !ConfigManager.gclass61_0.method_5("WalkLoot")
        ...
        while (!gclass36_1.method_3())
            if (gunit_0.IsValid)
            {
                if ((gunit_0.IsLootable || bool_20) && (gunit_0.IsSkinnable || !bool_20))
                {
                    ...
                    {
                        var num = GameMemoryAccess.ReadInt32(MemoryOffsetTable.Instance.GetIntOffset("LootWindow"), "LootWindow");
                        if (num != 0 || !flag)
                        {
                            if (num != 0)
                            {
