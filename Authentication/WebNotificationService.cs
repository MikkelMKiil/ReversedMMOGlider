...
public class WebNotificationService
{
    ...
    private int int_0;
    private readonly List<LogEntry> list_0;
    private readonly List<LogEntry> list_1;
    ...
    public WebNotificationService()
    {
        ...
        string_0 = "";
        string_1 = "";
        list_0 = new List<LogEntry>();
        list_1 = new List<LogEntry>();
    }
    ...
    public void method_0(string string_2)
    {
        ...
        lock (this)
        {
            list_0.Add(new LogEntry(string_2));
        }
    }
    ...
    public void method_1(string string_2)
    {
        ...
        lock (this)
        {
            list_1.Add(new LogEntry(string_2));
        }
    }

    public void method_2()
    {
        method_4("Applying config, enabled = " + ConfigManager.gclass61_0.method_5("WebNotifyEnabled"));
        if (bool_1 && ConfigManager.gclass61_0.method_5("WebNotifyEnabled") &&
            ConfigManager.gclass61_0.method_2("WebNotifyURL") == string_0 &&
            ConfigManager.gclass61_0.method_2("WebNotifyCredentials") == string_1)
        {
            method_4("Config is same on started WebNotify, skipping apply step");
        }
        else
        {
            string_0 = ConfigManager.gclass61_0.method_2("WebNotifyURL");
            string_1 = ConfigManager.gclass61_0.method_2("WebNotifyCredentials");
            method_5();
            if (!ConfigManager.gclass61_0.method_5("WebNotifyEnabled") || bool_1)
                return;
            method_3();
        }
    }
    ...
    private bool method_9(byte[] byte_0)
    {
        ...
        try
        {
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(ConfigManager.gclass61_0.method_2("WebNotifyURL"));
    ...
    private void method_11(XmlElement xmlElement_0, List<LogEntry> list_2, string string_2)
    {
